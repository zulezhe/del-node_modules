...
(async () => {
  await runTest('Test 1: Basic deletion (no safe mode)', async () => {
    setupTestStructure();
  ...
  await runTest('Test 2: Ignore functionality', async () => {
    setupTestStructure();
  ...
  await runTest('Test 3: I18n - Chinese', () => {
  ...
  await runTest('Test 4: I18n - English', () => {
  ...
  await runTest('Test 5: Empty directory (no node_modules)', async () => {
  ...
  await runTest('Test 6: Nested node_modules (should not recurse into deleted)', async () => {
    setupTestStructure();
  ...
  await runTest('Test 7: Multiple ignore patterns', async () => {
    setupTestStructure();
