    ...
    fn load_translations(language: &str) -> HashMap<String, String> {
        ...
        match language {
            "zh-CN" => {
                ...
                translations.insert("permissionDenied".to_string(), "权限不足: {path}，请尝试使用 --elevate 参数以管理员身份运行".to_string());
                translations.insert("elevating".to_string(), "正在请求管理员权限...".to_string());
                translations.insert("elevateFailed".to_string(), "请求管理员权限失败: {error}".to_string());
                translations.insert("alreadyAdmin".to_string(), "当前已是管理员权限".to_string());
            ...
            _ => {
                ...
                translations.insert("permissionDenied".to_string(), "Permission denied: {path}. Try running with --elevate for admin privileges".to_string());
                translations.insert("elevating".to_string(), "Requesting admin privileges...".to_string());
                translations.insert("elevateFailed".to_string(), "Failed to elevate privileges: {error}".to_string());
                translations.insert("alreadyAdmin".to_string(), "Already running with admin privileges".to_string());
